...
class Article extends CI_Controller
{
  ...
  public function show($slug = null)
  {
    ...
    $data['article'] = $this->article_model->find_by_slug($slug);//untuk memanggil method/fungsi find_by_slug di nama model yaitu article_model
